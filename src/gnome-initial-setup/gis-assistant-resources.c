...
static const SECTION union { const guint8 data[2497]; const double alignment; void * const ptr;}  gis_assistant_resource_data = { {
  ...
  0xc1, 0x09, 0x00, 0x00, 0x69, 0x6e, 0x69, 0x74, 
